export default function decorate(block) {
  ...
  const faetures = block.querySelectorAll("div.section.healthinsurance-container > div > div > div > div:nth-child(1) > p");
  console.log(faetures);
  faetures.forEach(feature => {
    const pEl3 = document.createElement('p');
    const iEl = document.createElement('i');
    const imgEl = document.createElement('img');
    imgEl.setAttribute('src', feature.querySelector("img").src);
    imgEl.setAttribute('alt', feature.textContent);
    imgEl.setAttribute('width', '40');
    imgEl.setAttribute('height', '40');
    iEl.append(imgEl);
    pEl3.append(iEl);
    pEl3.append(feature.textContent);
    asideEl.append(pEl3);
  });
  ...
  sourceEl.setAttribute('srcset', document.querySelector(".section.healthinsurance-container > div > div > div > div:nth-child(2) > picture > img").src);
  ...
  imgEl5.setAttribute('src', document.querySelector(".section.healthinsurance-container > div > div > div > div:nth-child(2) > picture > img").src);
